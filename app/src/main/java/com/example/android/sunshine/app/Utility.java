...
public class Utility {
     ...
     */
    public static int getSmallIconResourceForWeatherCondition(int weatherId) {
    ...
    public static Bitmap getLargeIconResourceForWeatherCondition(Context context,int weatherId) {
        // Based on weather code data found at:
        // http://bugs.openweathermap.org/projects/api/wiki/Weather_Condition_Codes
        if (weatherId >= 200 && weatherId <= 232) {
